...
select distinct substring_index(interests, ', ', 1) as interest # Interest 1 Split
from my_contacts
where interests is not null

UNION

select distinct substring_index(substring_index(interests, ', ', 2), ', ', -1) as interest # Interest 2 Split
from my_contacts
where interests is not null

UNION

select distinct substring_index(interests, ', ', -1) as interest # Interest 3 Split
from my_contacts
where interests is not null
order by interest;
